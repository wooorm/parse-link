...
test('parse(url)', function(t) {
  ...
  t.equal(parse('/p/a/t/h').pathname, '/p/a/t/h', '`pathname`: relative')

  t.equal(parse('mailto:test@example.com').pathname, '', '`pathname`: mailto')
  ...
  t.equal(parse('https://example.com').protocol, 'https:', '`protocol`: https')
  ...
  t.equal(parse('/p/a/t/h').protocol, '', '`protocol`: relative')
  ...
  t.equal(parse('/one/two/four').hostname, '', '`hostname`: relative')
  ...
  t.equal(parse('google.com/foo/bar').host, '', '`host`: without protocol')
  ...
  t.equal(parse('google.com/foo/bar').port, 80, '`port`: missing')
  ...
  t.equal(parse('http://google.com:3000/foo/bar').query, '', '`query`: missing')
  ...
  t.equal(parse('http://google.com:3000/foo/bar').hash, '', '`hash`: missing')
